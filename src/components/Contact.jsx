...
export default function Contact() {
  return (
    <section id="contact" className="mx-auto max-w-3xl scroll-mt-24 px-4 py-24 text-center sm:px-6 md:px-8">
      <Reveal>
        <p className="label mb-4 text-sky">05 · Kontak</p>
        <h2 className="font-display text-3xl font-bold text-fog sm:text-5xl">Mari Terhubung</h2>
        <p className="mx-auto mt-5 max-w-xl leading-relaxed text-fog-muted">
          ...
          {profile.socials
            ...
            .map((s) => (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex items-center gap-2 text-xs uppercase tracking-widest text-fog-faint transition-colors hover:text-sky"
              >
